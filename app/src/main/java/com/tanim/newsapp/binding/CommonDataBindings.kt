...
import com.tanim.newsapp.utils.ConverterUtils
...
fun loadImage(view: ImageView, data: String?) {
    if(data==null || !URLUtil.isValidUrl(data)) {
        view.setImageResource(R.drawable.ic_empty_image)
        return
    }
    Picasso.get().load(data).placeholder(R.drawable.ic_empty_image).into(view)
}
